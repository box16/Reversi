...
class GAME_CONTROLLER:
    def __init__(self, board_ui_controller, board_controller, canvas):
        self.board_ui_controller = board_ui_controller
        self.board_controller = board_controller
        self.teban = TRUN_CONTROLLER()
        canvas.bind("<Button-1>", self.click_event)

    def click_event(self, click_event):
        pos = self.board_ui_controller.convert_board_pos((click_event.x, click_event.y))
